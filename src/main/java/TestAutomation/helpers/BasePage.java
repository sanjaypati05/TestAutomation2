...
public class BasePage
{
	...
	public static void dragAndDropElementWithMouseHold(Config testConfig, WebElement sourceElement, WebElement targetElement, String sourceDescription, String targetDescription)
	{
		testConfig.logComment("Dragging element " + sourceDescription + " to " + targetDescription);
		...
		/*
		 * testConfig.logComment("Dragging element " + sourceDescription + " to " +
		 * targetDescription); Actions actions = new Actions(testConfig.driver);
		 * actions.dragAndDrop(sourceElement, targetElement).perform();
		 */
	}
	...
	public static void movetoElementAndClick(Config testConfig,WebElement element) {
		Actions action =new Actions(testConfig.driver);
		action.moveToElement(element).click().build().perform();
	}
	
	public static void movetoElementAndDoubleClick(Config testConfig,WebElement element) {
		Actions action =new Actions(testConfig.driver);
		action.moveToElement(element).doubleClick().build().perform();
	}
	
	public static void dragAndDropAnElement(Config testConfig,WebElement element1,WebElement element2) 
	{
		Actions builder = new Actions(testConfig.driver);
		Action dragAndDrop = builder.clickAndHold(element1)
				   .moveToElement(element2,149,59)
				   .release(element2)
				   .build();
				...
				/*
				 * Actions dragdrop = new Actions(testConfig.driver);
				 * //dragdrop.moveToElement(element1).clickAndHold();
				 * dragdrop.dragAndDrop(element1, element2);
				 * //dragdrop.moveToElement(element2,149,59); //dragdrop.release();
